...
%{
static INDEX _aiLeftAnimations[] = {
...
static INDEX _aiRightAnimations[] = {
...
procedures:
  Die() {
    ...
    for (INDEX iChar = 0; iChar < CT_BIGHEADS; iChar += 1) {
      ...
      CEntityPointer penDebris = GetWorld()->CreateEntity_t(CPlacement3D(vPos, ANGLE3D(0.0f, 0.0f, 0.0f)), CTFILENAME("Classes\\Debris.ecl"));
