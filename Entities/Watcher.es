...
functions:
  ...
  CEntity *CheckCloserPlayer(CEntity *penCurrentTarget, FLOAT fRange) {
    ...
    CEntity *penClosestPlayer = NULL;
    FLOAT fClosestPlayer = (penCurrentTarget->GetPlacement().pl_PositionVector - m_penOwner->GetPlacement().pl_PositionVector).Length();
  ...
  CEntity *CheckAnotherPlayer(CEntity *penCurrentTarget) {
    ...
    CEntity *penClosestPlayer = NULL;
    FLOAT fCurrentDistance = (penCurrentTarget->GetPlacement().pl_PositionVector - m_penOwner->GetPlacement().pl_PositionVector).Length();
