...
properties:
  ...
  34 FLOAT m_tmRockingChange = 1.0f, // how many second to change rocking parameters
  35 FLOAT m_tmRockingChangeStart = -1.0f, // when changing of rocking parameters has started
...
functions:
  ...
  CAnimData *GetAnimData(SLONG slPropertyOffset) {
    if ((slPropertyOffset == offsetof(CShip, m_iSailUpAnim) || slPropertyOffset == offsetof(CShip, m_iSailDownAnim)
      || slPropertyOffset == offsetof(CShip, m_iSailSailAnim) || slPropertyOffset == offsetof(CShip, m_iSailWaveingAnim))
        && m_penSail != NULL) {
