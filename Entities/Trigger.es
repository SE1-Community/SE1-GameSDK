...
properties:
 ...
 24 CEntityPointer m_penTarget10 "Target 10" COLOR(C_RED|0xFF),
  ...
  8 enum EEventType m_eetEvent1  "Event type Target 01" 'G' = EET_TRIGGER, // type of event to send
  9 enum EEventType m_eetEvent2  "Event type Target 02" 'H' = EET_TRIGGER,
 10 enum EEventType m_eetEvent3  "Event type Target 03" 'J' = EET_TRIGGER,
 11 enum EEventType m_eetEvent4  "Event type Target 04" 'K' = EET_TRIGGER,
 12 enum EEventType m_eetEvent5  "Event type Target 05" 'L' = EET_TRIGGER,
 50 enum EEventType m_eetEvent6  "Event type Target 06" = EET_TRIGGER,
 51 enum EEventType m_eetEvent7  "Event type Target 07" = EET_TRIGGER,
 52 enum EEventType m_eetEvent8  "Event type Target 08" = EET_TRIGGER,
 53 enum EEventType m_eetEvent9  "Event type Target 09" = EET_TRIGGER,
 54 enum EEventType m_eetEvent10 "Event type Target 10" = EET_TRIGGER,
 ...
 38 enum EEventType m_eetRange "Event type Range" = EET_IGNORE, // type of event to send in range
