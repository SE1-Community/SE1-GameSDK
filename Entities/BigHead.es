...
// [Cecil] 2021-03-06: Walk animations for each type
static const INDEX _aiWalkAnims[] = {
  MENTAL_ANIM_RUN,
  MENTAL_ANIM_WALKZOMBIE,
  MENTAL_ANIM_WALKANGEL,
};
%}
...
functions:
  ...
  INDEX GetWalkAnim(void) {
    return _aiWalkAnims[m_bhtType];
  }

  // Damage anim
  INDEX AnimForDamage(FLOAT fDamage) {
    INDEX iAnim = MENTAL_ANIM_PANIC;
  ...
  void PlayWalkSound(void) {
    ...
    switch (m_bhtType) {
      case BHT_ZOMBIE: iSound = SOUND_WALKZOMBIE; break;
      case BHT_SAINT: iSound = SOUND_WALKSAINT; break;
      default: { return; }
    }
