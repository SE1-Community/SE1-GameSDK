...
properties:
 ...
 10 enum EEventType m_eetMarkerEvent "Marker Event - Type" 'J' = EET_IGNORE, // type of event to send
 11 CEntityPointer m_penMarkerEvent  "Marker Event - Target" 'K', // target to send event to

 // send event on touch
 16 enum EEventType m_eetTouchEvent "Touch Event - Type" 'U' = EET_IGNORE, // type of event to send
