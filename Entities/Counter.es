...
functions:
  ...
  void DisplayNumber(void) {
    for (INDEX iDigit = 0; iDigit < 10; iDigit++) {
      ...
      if (pmh != NULL && pmh->GetModelObject() != NULL && pmh->GetModelObject()->mo_toTexture.GetData() != NULL) {
        ...
        // play sound
        m_soSound.Set3DParameters(200.0f, 100.0f, 1.0f, Clamp(1.0f + (m_iCountFrom - m_fNumber) / m_iCountFrom * 2.0f, 1.0f, 3.0f));
