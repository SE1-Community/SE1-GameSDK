...
enum ArmorItemType {
  0 ARIT_SHARD  "Shard",
  1 ARIT_SMALL  "Small",
  2 ARIT_MEDIUM "Medium",
  3 ARIT_STRONG "Strong",
  4 ARIT_SUPER  "Super",
  5 ARIT_HELM   "Helm",
};
...
functions:
  ...
  void RenderParticles(void) {
    ...
    switch (m_EaitType) {
      case ARIT_SHARD: Particles_Emanate(this, 0.75f * 0.75, 0.75f * 0.75, PT_STAR04, 8, 7.0f); break;
      case ARIT_SMALL: Particles_Emanate(this, 1.0f * 0.75, 1.0f * 0.75, PT_STAR04, 32, 7.0f); break;
      case ARIT_MEDIUM: Particles_Emanate(this, 1.5f * 0.75, 1.5f * 0.75, PT_STAR04, 64, 7.0f); break;
      case ARIT_STRONG: Particles_Emanate(this, 2.0f * 0.75, 1.25f * 0.75, PT_STAR04, 96, 7.0f); break;
      case ARIT_SUPER: Particles_Emanate(this, 2.5f * 0.75, 1.5f * 0.75, PT_STAR04, 128, 7.0f); break;
      case ARIT_HELM: Particles_Emanate(this, 0.875f * 0.75, 0.875f * 0.75, PT_STAR04, 16, 7.0f); break;
    }
  }
