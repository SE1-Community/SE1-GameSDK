...
properties:
 ...
 13 BOOL m_bBackground "Background" 'B' = FALSE, // set if particles are rendered in background
 21 BOOL m_bTargetable "Targetable" = FALSE, // set if particles should be targetable
...
functions:
  ...
  void RenderParticles(void) {
    ...
    switch (m_phtType) {
      ...
      case PHT_RISING:
        Particles_Rising(this, m_fActivateTime, m_fDeactivateTime, m_fStretchAll, m_fStretchX, m_fStretchY, m_fStretchZ,
                         m_fSize, m_ptTexture, m_ctCount);
        break;
      ...
      case PHT_EMANATEPLANE:
        Particles_EmanatePlane(this, m_fStretchX, m_fStretchY, m_fStretchZ, m_fSize, m_fParam1, m_fParam2,
                               m_ptTexture, m_ctCount, m_fMipFactorDisappear);
        break;
      ...
      case PHT_WATERFALLFOAM:
        Particles_WaterfallFoam(this, m_fStretchX, m_fStretchY, m_fStretchZ, m_fSize, m_fParam1, m_fParam2, m_fParam3, m_ctCount);
        break;
      ...
      case PHT_ROCKETMOTOR:
        Particles_RocketMotorBurning(this, m_ctCount, FLOAT3D(m_fStretchX, m_fStretchY, m_fStretchZ), m_fSize, m_ctCount);
        break;
  ...
  void StretchModel(void) {
    ...
    GetModelObject()->StretchModel(FLOAT3D(m_fStretchAll * m_fStretchX, m_fStretchAll * m_fStretchY, m_fStretchAll * m_fStretchZ));
    ModelChangeNotify();
  };
