...
void DECL_DLL Particles_BrushBurning(CEntity *pen, FLOAT3D vPos[], INDEX ctCount, FLOAT3D vPlane, FLOAT fPower, FLOAT fTimeRatio);
void DECL_DLL Particles_FlameThrower(const CPlacement3D &plLeader, const CPlacement3D &plFollower, FLOAT3D vSpeedLeader,
...
void DECL_DLL Particles_Rising(CEntity *pen, FLOAT m_fActivateTime, FLOAT m_fDeactivateTime, FLOAT fStretchAll, FLOAT fStretchX,
                               FLOAT fStretchY, FLOAT fStretchZ, FLOAT fSize, enum ParticleTexture ptTexture, INDEX ctParticles);
...
void DECL_DLL Particles_PowerUpIndicator(CEntity *pen, enum ParticleTexture ptTexture, FLOAT fSize, FLOAT fScale, FLOAT fHeight,
                                         INDEX ctEllipses, INDEX iTrailCount);
void DECL_DLL Particles_BloodSpray(enum SprayParticlesType sptType, FLOAT3D vPos, FLOAT3D vGDir, FLOAT fGA,
                                   FLOATaabbox3D boxOwner, FLOAT3D vSpilDirection, FLOAT tmStarted, FLOAT fDamagePower,
                                   COLOR colMultiply = C_WHITE | CT_OPAQUE);
void DECL_DLL Particles_EmanatePlane(CEntity *pen, FLOAT fSizeX, FLOAT fSizeY, FLOAT fSizeZ, FLOAT fParticleSize, FLOAT fAway,
                                     FLOAT fSpeed, enum ParticleTexture ptTexture, INDEX ctParticles, FLOAT fMipFactorDisappear);
void DECL_DLL Particles_WaterfallFoam(CEntity *pen, FLOAT fSizeX, FLOAT fSizeY, FLOAT fSizeZ, FLOAT fParticleSize, FLOAT fSpeed,
...
void DECL_DLL Particles_LavaErupting(CEntity *pen, FLOAT fStretchAll, FLOAT fSize, FLOAT fStretchX, FLOAT fStretchY,
                                     FLOAT fStretchZ, FLOAT fActivateTime);
...
void DECL_DLL Particles_Rain(CEntity *pen, FLOAT fGridSize, INDEX ctGrids, FLOAT fFactor, CTextureData *ptdRainMap,
                             FLOATaabbox3D &boxRainMap);
void DECL_DLL Particles_Snow(CEntity *pen, FLOAT fGridSize, INDEX ctGrids, FLOAT fPower, CTextureData *ptdRainMap,
                             FLOATaabbox3D &boxRainMap, FLOAT fSnowStart);
void DECL_DLL Particles_Lightning(FLOAT3D vSrc, FLOAT3D vDst, FLOAT fTimeStart);
void DECL_DLL Particles_BulletSpray(INDEX iRndBase, FLOAT3D vSource, FLOAT3D vGDir, enum EffectParticlesType eptType,
...
void DECL_DLL Particles_ShooterFlame(const CPlacement3D &plEnd, const CPlacement3D &plStart, FLOAT fEndElapsed,
                                     FLOAT fStartElapsed);
void DECL_DLL Particles_SummonerProjectileFly(CEntity *pen, FLOAT fSize, FLOAT fTimeAdjust);
void DECL_DLL Particles_SummonerProjectileExplode(CEntity *pen, FLOAT fSize, FLOAT fBeginTime, FLOAT fDuration,
                                                  FLOAT fTimeAdjust);
void DECL_DLL Particles_SummonerExplode(CEntity *pen, FLOAT3D vCenter, FLOAT fArea, FLOAT fSize, FLOAT fBeginTime,
                                        FLOAT fDuration);
void DECL_DLL Particles_ExotechLarvaLaser(CEntity *pen, FLOAT3D vSource, FLOAT3D vTarget);
void DECL_DLL Particles_Smoke(CEntity *pen, FLOAT3D vOffset, INDEX ctCount, FLOAT fLife, FLOAT fSpread, FLOAT fStretchAll,
                              FLOAT fYSpeed);
...
void DECL_DLL Particles_Leaves(CEntity *penTree, FLOATaabbox3D boxSize, FLOAT3D vSource, FLOAT fDamagePower, FLOAT fLaunchPower,
                               FLOAT3D vGDir, FLOAT fGA, FLOAT tmStarted, COLOR colMaxColor);
...
void DECL_DLL Particles_ModelGlow(CEntity *pen, FLOAT tmEnd, enum ParticleTexture ptTexture, FLOAT fSize, FLOAT iVtxStep,
                                  FLOAT fAnimSpd, COLOR iCol);
...
void DECL_DLL Particles_ModelGlow2(CModelObject *mo, CPlacement3D pl, FLOAT tmEnd, enum ParticleTexture ptTexture, FLOAT fSize,
