...
functions:
  ...
  BOOL AdjustShadingParameters(FLOAT3D &vLightDirection, COLOR &colLight, COLOR &colAmbient) {
    if (m_bFade) {
      ...
      col = (col & ~CT_AMASK) | (ULONG)((255) * Clamp(tmAge * m_fFadeInSpeed / m_fWaitTime, 0.0f, 1.0f));
      SetModelColor(col);
    }
  ...
  void BloodExplode(void) {
    ...
    if (iBloodType == 3) {
      ...
      switch (IRnd() & 3) {
        case 1: {
          SetModelMainTexture(TEXTURE_BLOOD_FLOWER1);
          break;
        }
        case 2: {
          SetModelMainTexture(TEXTURE_BLOOD_FLOWER2);
          break;
        }
        case 3: {
          SetModelMainTexture(TEXTURE_BLOOD_FLOWER3);
          break;
        }
        default: {
          SetModelMainTexture(TEXTURE_BLOOD_FLOWER1);
      ...
      if (iBloodType == 2) {
        SetModelColor(RGBAToColor(250, 20, 20, 255));
      } else {
  ...
  void BloodStain(void) {
    ...
    if (iBloodType == 3) {
      ...
      switch (IRnd() & 3) {
        case 1: {
          SetModelMainTexture(TEXTURE_BLOOD_STAIN1);
          break;
        }
        case 2: {
          SetModelMainTexture(TEXTURE_BLOOD_STAIN2);
          break;
        }
        case 3: {
  ...
  void BloodSpill(COLOR colBloodSpillColor) {
    ...
    if (iBloodType == 3) {
      ...
      switch (IRnd() % 5) {
        case 1: {
          SetModelMainTexture(TEXTURE_BLOOD_SPILL1);
          break;
        }
        case 2: {
          SetModelMainTexture(TEXTURE_BLOOD_SPILL2);
          break;
        }
        case 3: {
          SetModelMainTexture(TEXTURE_BLOOD_SPILL1);
        ...
        default: {
          SetModelMainTexture(TEXTURE_BLOOD_SPILL3);
          break;
        }
      }
      if (iBloodType == 2) {
