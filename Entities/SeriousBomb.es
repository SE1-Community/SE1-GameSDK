  ...
  void ExplodeBomb(void) {
    ...
    FOREACHINDYNAMICCONTAINER(this->GetWorld()->wo_cenEntities, CEntity, iten) {
      ...
      if (IsDerivedFromClass(pen, "Enemy Base")) {
        ...
        this->InflictDirectDamage(pen, this, DMT_EXPLOSION, penEnemy->GetHealth() + 100.0f,
                                  pen->GetPlacement().pl_PositionVector, FLOAT3D(0.0f, 1.0f, 0.0f));
      }
    }
  }
...
procedures:
  ...
  Main(ESeriousBomb esb) {
    ...
    if (esb.penOwner) {
      ...
      if (_pNetwork->IsPlayerLocal(m_penOwner)) {
        IFeel_PlayEffect("SeriousBombBlow");
      }
      ...
      // explode bomb twice just to be sure
      ExplodeBomb();
      autowait(0.25f);
