  ...
  BOOL LoadOneFile(const CTFileName &fnm) {
    ...
    try {
      ...
      while (!strm.AtEOF()) {
        ...
        if (strArgs == "CENTER") {
          cceEntry.iAlign = CTA_CENTER;
        } else if (strArgs == "RIGHT") {
          cceEntry.iAlign = CTA_RIGHT;
        } else if (TRUE) {
          cceEntry.iAlign = CTA_LEFT;
        }
  ...
  FLOAT Credits_Render(CCreditsHolder *penThis, CDrawPort *pdp) {
    ...
    if (!bOver) {
      while (TRUE) {
        ...
        if (_acceEntries[iNextItem].fWait != 0.0f) {
          bLast = TRUE;
        }
        ...
        if (_acceEntries[iNextItem].iAlign == CTA_CENTER) {
          ...
          pdp->PutTextC(_acceEntries[iNextItem].strTitle, _acceEntries[iNextItem].iX * fResFactor, fYY,
          ...
          pdp->PutTextC(_acceEntries[iNextItem].strName, _acceEntries[iNextItem].iX * fResFactor, fYY,
                        C_WHITE | (INDEX)(fFade * 255));
          fYY += fTextSize02 * fResFactor * fTextHeight * fSpacing02;

          pdp->SetTextScaling(fTextSize03 * fResFactor);
          pdp->PutTextC(_acceEntries[iNextItem].strQuote, _acceEntries[iNextItem].iX * fResFactor, fYY,
                        C_WHITE | (INDEX)(fFade * 255));
          ...
          pdp->SetTextScaling(fTextSize01 * fResFactor);
          pdp->PutTextR(_acceEntries[iNextItem].strTitle, _acceEntries[iNextItem].iX * fResFactor, fYY,
                        C_WHITE | (INDEX)(fFade * 255));
          fYY += fTextSize01 * fResFactor * fTextHeight * fSpacing01;

          pdp->SetTextScaling(fTextSize02 * fResFactor);
          pdp->PutTextR(_acceEntries[iNextItem].strName, _acceEntries[iNextItem].iX * fResFactor, fYY,
                        C_WHITE | (INDEX)(fFade * 255));
          fYY += fTextSize02 * fResFactor * fTextHeight * fSpacing02;

          pdp->SetTextScaling(fTextSize03 * fResFactor);
          pdp->PutTextR(_acceEntries[iNextItem].strQuote, _acceEntries[iNextItem].iX * fResFactor, fYY,
                        C_WHITE | (INDEX)(fFade * 255));
          ...
          pdp->SetTextScaling(fTextSize01 * fResFactor);
          pdp->PutText(_acceEntries[iNextItem].strTitle, _acceEntries[iNextItem].iX * fResFactor, fYY,
                       C_WHITE | (INDEX)(fFade * 255));
          fYY += fTextSize01 * fResFactor * fTextHeight * fSpacing01;

          pdp->SetTextScaling(fTextSize02 * fResFactor);
          pdp->PutText(_acceEntries[iNextItem].strName, _acceEntries[iNextItem].iX * fResFactor, fYY,
                       C_WHITE | (INDEX)(fFade * 255));
          fYY += fTextSize02 * fResFactor * fTextHeight * fSpacing02;

          pdp->SetTextScaling(fTextSize03 * fResFactor);
          pdp->PutText(_acceEntries[iNextItem].strQuote, _acceEntries[iNextItem].iX * fResFactor, fYY,
                       C_WHITE | (INDEX)(fFade * 255));
        }
