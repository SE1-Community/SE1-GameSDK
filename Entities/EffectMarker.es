...
functions:
  ...
  BOOL IsTargetValid(SLONG slPropertyOffset, CEntity *penTarget) {
    ...
    if (slPropertyOffset == offsetof(CEffectMarker, m_penModel) || slPropertyOffset == offsetof(CEffectMarker, m_penModel2)) {
      ...
      switch (m_emtType) {
        ...
        case EMT_GLARE: {
          ...
          if (pwsc != NULL) {
            ...
            pwsc->m_tmGlaringEnded = pwsc->m_tmGlaringStarted + m_tmEffectLife, pwsc->m_fGlaringFadeInRatio = 0.2f;
