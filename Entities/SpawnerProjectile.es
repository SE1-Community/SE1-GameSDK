...
// Input parameter for spawner projectile
...
functions:
  void SpawnEntity() {
    ...
    pen = GetWorld()->CopyEntityInWorld(
      *m_penTemplate, CPlacement3D(FLOAT3D(-32000.0f + FRnd() * 200.0f, -32000.0f + FRnd() * 200.0f, 0), ANGLE3D(0.0f, 0.0f, 0.0f)));
    ...
    // adjust circle radius to account for enemy size
    FLOAT fEntityR = 0;
