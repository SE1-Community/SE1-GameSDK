...
properties:
 ...
 // shake strength
 24 FLOAT m_fShakeIntensityY = 1.0f,
 25 FLOAT m_tmShakeFrequencyY = 1.0f,
 26 FLOAT m_fShakeIntensityB = 1.0f,
 27 FLOAT m_tmShakeFrequencyB = 1.0f,
 31 FLOAT m_fShakeIntensityZ = 1.0f,
 32 FLOAT m_tmShakeFrequencyZ = 1.0f,
 ...
 // [Cecil] TODO: Uncomment for TFE support
...
functions:
  BOOL IsTargetValid(SLONG slPropertyOffset, CEntity *penTarget) {
    if (slPropertyOffset == offsetof(CWorldSettingsController, m_penEnvPartHolder)) {
      if (IsOfClass(penTarget, "EnvironmentParticlesHolder")) {
        return TRUE;
      } else {
        return FALSE;
      }
