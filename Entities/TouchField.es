...
properties:
  ...
  3 enum EEventType m_eetEnter "Enter Event" 'E' = EET_TRIGGER, // event to send on enter
  7 CEntityPointer m_penExit   "Exit Target" COLOR(C_dRED|0xFF), // target to send event to
  8 enum EEventType m_eetExit  "Exit Event" = EET_TRIGGER, // event to send on exit
